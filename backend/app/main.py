...
def create_app() -> FastAPI:
    ...
    from app.api.websocket import widget_websocket_endpoint, dashboard_websocket_endpoint
    # Mount WebSocket routes directly on the app for reliable path matching
    app.add_api_websocket_route("/api/v1/ws/widget/{conversation_id}", widget_websocket_endpoint)
    app.add_api_websocket_route("/api/v1/ws/dashboard/{workspace_id}", dashboard_websocket_endpoint)
    # Keep legacy dashboard path for backwards compatibility
    app.add_api_websocket_route("/api/v1/ws/widget/dashboard/{workspace_id}", dashboard_websocket_endpoint)
    ...
    from app.services.ticket_automation import initialize_ticket_automation
